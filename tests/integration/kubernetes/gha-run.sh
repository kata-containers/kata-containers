...
function deploy_kata() {
	...
	echo "::group::kata-deploy resolved CI inputs"
	echo "KATA_HYPERVISOR=${KATA_HYPERVISOR}"
	echo "SNAPSHOTTER=${SNAPSHOTTER}"
	echo "EROFS_SNAPSHOTTER_MODE=${EROFS_SNAPSHOTTER_MODE:-}"
	echo "EROFS_MERGE_MODE=${EROFS_MERGE_MODE:-}"
	echo "HELM_SHIMS=${HELM_SHIMS}"
	echo "HELM_DEFAULT_SHIM=${HELM_DEFAULT_SHIM}"
	...
	echo "HELM_EXPERIMENTAL_FORCE_GUEST_PULL=${HELM_EXPERIMENTAL_FORCE_GUEST_PULL}"
	echo "::endgroup::"
