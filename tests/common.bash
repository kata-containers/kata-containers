...
function extract_kata_env() {
	...
	if [[ ! "${KATA_HYPERVISOR}" =~ ^(dragonball|clh-runtime-rs|qemu-runtime-rs|qemu-se-runtime-rs)$ ]]; then
...
function enabling_hypervisor() {
	...
	case "${KATA_HYPERVISOR}" in
		dragonball|clh-runtime-rs|clh-azure-runtime-rs|qemu-runtime-rs|qemu-se-runtime-rs|fc-rs)
