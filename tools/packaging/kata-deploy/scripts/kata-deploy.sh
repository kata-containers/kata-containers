...
. "${SCRIPT_DIR}/runtimeclasses.sh"
. "${SCRIPT_DIR}/nfd.sh"
. "${SCRIPT_DIR}/artifacts.sh"
. "${SCRIPT_DIR}/cri-o.sh"
. "${SCRIPT_DIR}/containerd.sh"
. "${SCRIPT_DIR}/snapshotters.sh"
...
main() {
	...
	case "$runtime" in
		crio|containerd|k3s|k3s-agent|rke2-agent|rke2-server|k0s-worker|k0s-controller|microk8s)
