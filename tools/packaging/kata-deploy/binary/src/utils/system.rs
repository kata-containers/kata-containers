...
pub fn get_kata_containers_config_path(shim: &str, dest_dir: &str) -> String {
    let base_path = get_kata_containers_original_config_path(shim, dest_dir);
...
pub fn get_kata_containers_original_config_path(shim: &str, dest_dir: &str) -> String {
...
mod tests {
    ...
    fn test_get_kata_containers_original_config_path(
        ...
        assert_eq!(get_kata_containers_original_config_path(shim, dest_dir), expected);
    }
    ...
    fn test_get_kata_containers_config_path(
        ...
        assert_eq!(get_kata_containers_config_path(shim, dest_dir), expected);
    }
