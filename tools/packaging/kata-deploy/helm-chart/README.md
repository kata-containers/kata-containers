...
```sh
# Install directly from the official release tarball
# update the release X.YY.Z to your needs or just use the latest
...
For debugging, testing and other use-case it is possible to deploy mulitple
versions of Kata on the very same node. All the needed artficats are getting the
