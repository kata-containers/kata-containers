...
is the part of job mode that holds Kubernetes credentials, and root on the node it
lands on can read them; confining it to trusted nodes is a hardening step a
DaemonSet cannot offer, having to run everywhere by definition.
