...
func toGRPC(err error) error {
	...
	switch {
	case isInvalidArgument(causeErr):
		return status.Errorf(codes.InvalidArgument, causeErr.Error())
	case isNotFound(causeErr):
		return status.Errorf(codes.NotFound, causeErr.Error())
	}
