...
const (
	...
	unsupportedMessage    = "System check not implemented on Darwin " + katautils.PROJECT
...
`,
	...
	Action: func(context *cli.Context) error {
		...
		_, ok := context.App.Metadata["runtimeConfig"].(oci.RuntimeConfig)
		if !ok {
			return errors.New("check: cannot determine runtime config")
		}

		err := hostIsVMContainerCapable(vmContainerCapableDetails{})
		if err != nil {
			return err
		}
		fmt.Println(unsupportedMessage)
