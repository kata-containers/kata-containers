...
func (s *Sandbox) dumpConfig(ss *persistapi.SandboxState) {
	...
	ss.Config.HypervisorConfig = persistapi.HypervisorConfig{
		...
		PCIeLazyAttachVendor:    sconfig.HypervisorConfig.PCIeLazyAttachVendor,
		PCIeLazyAttachDelay:     sconfig.HypervisorConfig.PCIeLazyAttachDelay,
...
func loadSandboxConfig(id string) (*SandboxConfig, error) {
	...
	sconfig.HypervisorConfig = HypervisorConfig{
		...
		PCIeLazyAttachVendor:    hconf.PCIeLazyAttachVendor,
		PCIeLazyAttachDelay:     hconf.PCIeLazyAttachDelay,
