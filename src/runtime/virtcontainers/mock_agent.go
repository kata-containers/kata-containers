...
// pullImage is the Noop image pull implementation. It does nothing.
func (n *mockAgent) pullImage(ctx context.Context, sandbox *Sandbox, c Container, image string, container_ID string) error {
	return nil
}
