...
type SetInitdataRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Initdata string `protobuf:"bytes,1,opt,name=initdata,proto3" json:"initdata,omitempty"`
}

func (x *SetInitdataRequest) Reset() {
	*x = SetInitdataRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SetInitdataRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetInitdataRequest) ProtoMessage() {}

func (x *SetInitdataRequest) ProtoReflect() protoreflect.Message {
	mi := &file_agent_proto_msgTypes[67]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetInitdataRequest.ProtoReflect.Descriptor instead.
func (*SetInitdataRequest) Descriptor() ([]byte, []int) {
	return file_agent_proto_rawDescGZIP(), []int{67}
}

func (x *SetInitdataRequest) GetInitdata() string {
	if x != nil {
		return x.Initdata
	}
	return ""
...
var file_agent_proto_rawDesc = []byte{
	...
	0x07, 0x50, 0x43, 0x49, 0x50, 0x61, 0x74, 0x68, 0x22, 0x13, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x4d,
	...
	0x06, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x22, 0x30, 0x0a, 0x12, 0x53, 0x65, 0x74, 0x49, 0x6e,
	0x69, 0x74, 0x64, 0x61, 0x74, 0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1a, 0x0a,
	0x08, 0x69, 0x6e, 0x69, 0x74, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x08, 0x69, 0x6e, 0x69, 0x74, 0x64, 0x61, 0x74, 0x61, 0x32, 0x82, 0x15, 0x0a, 0x0c, 0x41, 0x67,
	...
	0x0b, 0x53, 0x65, 0x74, 0x49, 0x6e, 0x69, 0x74, 0x64, 0x61, 0x74, 0x61, 0x12, 0x18, 0x2e, 0x67,
	0x72, 0x70, 0x63, 0x2e, 0x53, 0x65, 0x74, 0x49, 0x6e, 0x69, 0x74, 0x64, 0x61, 0x74, 0x61, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e,
...
var file_agent_proto_goTypes = []interface{}{
	...
	(*SetInitdataRequest)(nil),                    // 67: grpc.SetInitdataRequest
...
var file_agent_proto_depIdxs = []int32{
	...
	67, // 80: grpc.AgentService.SetInitdata:input_type -> grpc.SetInitdataRequest
	...
	77, // 119: grpc.AgentService.SetInitdata:output_type -> google.protobuf.Empty
...
func file_agent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_agent_proto_msgTypes[67].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SetInitdataRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
