...
// ConfidentialStorageProfile selects a fixed in-guest storage protection
// contract. New profiles must use new enum values rather than changing the
// meaning of an existing value.
type ConfidentialStorageProfile int32

const (
	ConfidentialStorageProfile_Unspecified        ConfidentialStorageProfile = 0
	ConfidentialStorageProfile_Luks2IntegrityExt4 ConfidentialStorageProfile = 1
)

// Enum value maps for ConfidentialStorageProfile.
var (
	ConfidentialStorageProfile_name = map[int32]string{
		0: "Unspecified",
		1: "Luks2IntegrityExt4",
	}
	ConfidentialStorageProfile_value = map[string]int32{
		"Unspecified":        0,
		"Luks2IntegrityExt4": 1,
	}
)

func (x ConfidentialStorageProfile) Enum() *ConfidentialStorageProfile {
	p := new(ConfidentialStorageProfile)
	*p = x
	return p
}

func (x ConfidentialStorageProfile) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ConfidentialStorageProfile) Descriptor() protoreflect.EnumDescriptor {
	return file_agent_proto_enumTypes[0].Descriptor()
}

func (ConfidentialStorageProfile) Type() protoreflect.EnumType {
	return &file_agent_proto_enumTypes[0]
}

func (x ConfidentialStorageProfile) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ConfidentialStorageProfile.Descriptor instead.
func (ConfidentialStorageProfile) EnumDescriptor() ([]byte, []int) {
...
// ConfidentialStorage contains non-secret inputs for a storage activation
// that is authorized by measured init-data and executed inside the guest.
type ConfidentialStorage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Profile  ConfidentialStorageProfile `protobuf:"varint,1,opt,name=profile,proto3,enum=grpc.ConfidentialStorageProfile" json:"profile,omitempty"`
	VolumeId string                     `protobuf:"bytes,2,opt,name=volume_id,json=volumeId,proto3" json:"volume_id,omitempty"`
	KeyUri   string                     `protobuf:"bytes,3,opt,name=key_uri,json=keyUri,proto3" json:"key_uri,omitempty"`
}

func (x *ConfidentialStorage) Reset() {
	*x = ConfidentialStorage{}
	if protoimpl.UnsafeEnabled {
...
func (x *ConfidentialStorage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConfidentialStorage) ProtoMessage() {}

func (x *ConfidentialStorage) ProtoReflect() protoreflect.Message {
	mi := &file_agent_proto_msgTypes[55]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConfidentialStorage.ProtoReflect.Descriptor instead.
func (*ConfidentialStorage) Descriptor() ([]byte, []int) {
	return file_agent_proto_rawDescGZIP(), []int{55}
}

func (x *ConfidentialStorage) GetProfile() ConfidentialStorageProfile {
	if x != nil {
		return x.Profile
	}
	return ConfidentialStorageProfile_Unspecified
}

func (x *ConfidentialStorage) GetVolumeId() string {
	if x != nil {
		return x.VolumeId
	}
	return ""
...
func (x *ConfidentialStorage) GetKeyUri() string {
	if x != nil {
		return x.KeyUri
	}
	return ""
...
type Storage struct {
	...
	// ConfidentialStorage asks the agent to activate this block device through
	// CDH only after matching the complete request against measured init-data.
	ConfidentialStorage *ConfidentialStorage `protobuf:"bytes,9,opt,name=confidential_storage,json=confidentialStorage,proto3" json:"confidential_storage,omitempty"`
}
...
func (x *Storage) GetConfidentialStorage() *ConfidentialStorage {
	if x != nil {
		return x.ConfidentialStorage
	}
	return nil
}
...
var file_agent_proto_rawDesc = []byte{
	...
	,
	...
	0x79, 0x22, 0x58, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x44, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74,
	0x69, 0x63, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x19, 0x0a,
	0x08, 0x6c, 0x6f, 0x67, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x6c, 0x6f, 0x67, 0x54, 0x79, 0x70, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x6f, 0x6e, 0x74,
	0x61, 0x69, 0x6e, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b,
	0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x49, 0x64, 0x22, 0x2f, 0x0a, 0x19, 0x47,
	...
	,
	...
	,
	...
	,
...
var file_agent_proto_goTypes = []interface{}{
	(ConfidentialStorageProfile)(0),               // 0: grpc.ConfidentialStorageProfile
	...
	(*ConfidentialStorage)(nil),                   // 56: grpc.ConfidentialStorage
	...
	(*GetDiagnosticDataRequest)(nil),              // 70: grpc.GetDiagnosticDataRequest
	(*GetDiagnosticDataResponse)(nil),             // 71: grpc.GetDiagnosticDataResponse
	(*MemAgentMemcgConfig)(nil),                   // 72: grpc.MemAgentMemcgConfig
	(*MemAgentCompactConfig)(nil),                 // 73: grpc.MemAgentCompactConfig
	nil,                                           // 74: grpc.MemoryStats.StatsEntry
	nil,                                           // 75: grpc.CgroupStats.HugetlbStatsEntry
	(*Spec)(nil),                                  // 76: grpc.Spec
	(*Process)(nil),                               // 77: grpc.Process
	(*LinuxResources)(nil),                        // 78: grpc.LinuxResources
	(*protocols.Interface)(nil),                   // 79: types.Interface
	(*protocols.Route)(nil),                       // 80: types.Route
	(*protocols.ARPNeighbor)(nil),                 // 81: types.ARPNeighbor
	(protocols.FSGroupChangePolicy)(0),            // 82: types.FSGroupChangePolicy
	(*emptypb.Empty)(nil),                         // 83: google.protobuf.Empty
	(*VolumeStatsResponse)(nil),                   // 84: grpc.VolumeStatsResponse
}
var file_agent_proto_depIdxs = []int32{
	...
	76, // 3: grpc.CreateContainerRequest.OCI:type_name -> grpc.Spec
	...
	77, // 6: grpc.ExecProcessRequest.process:type_name -> grpc.Process
	78, // 7: grpc.UpdateContainerRequest.resources:type_name -> grpc.LinuxResources
	...
	74, // 13: grpc.MemoryStats.stats:type_name -> grpc.MemoryStats.StatsEntry
	...
	75, // 26: grpc.CgroupStats.hugetlb_stats:type_name -> grpc.CgroupStats.HugetlbStatsEntry
	...
	79, // 31: grpc.Interfaces.Interfaces:type_name -> types.Interface
	80, // 32: grpc.Routes.Routes:type_name -> types.Route
	79, // 33: grpc.UpdateInterfaceRequest.interface:type_name -> types.Interface
	...
	81, // 36: grpc.ARPNeighbors.ARPNeighbors:type_name -> types.ARPNeighbor
	...
	82, // 39: grpc.FSGroup.group_change_policy:type_name -> types.FSGroupChangePolicy
	0,  // 40: grpc.ConfidentialStorage.profile:type_name -> grpc.ConfidentialStorageProfile
	54, // 41: grpc.Storage.fs_group:type_name -> grpc.FSGroup
	56, // 42: grpc.Storage.confidential_storage:type_name -> grpc.ConfidentialStorage
	20, // 43: grpc.CgroupStats.HugetlbStatsEntry.value:type_name -> grpc.HugetlbStats
	1,  // 44: grpc.AgentService.CreateContainer:input_type -> grpc.CreateContainerRequest
	2,  // 45: grpc.AgentService.StartContainer:input_type -> grpc.StartContainerRequest
	3,  // 46: grpc.AgentService.RemoveContainer:input_type -> grpc.RemoveContainerRequest
	4,  // 47: grpc.AgentService.ExecProcess:input_type -> grpc.ExecProcessRequest
	5,  // 48: grpc.AgentService.SignalProcess:input_type -> grpc.SignalProcessRequest
	6,  // 49: grpc.AgentService.WaitProcess:input_type -> grpc.WaitProcessRequest
	8,  // 50: grpc.AgentService.UpdateContainer:input_type -> grpc.UpdateContainerRequest
	38, // 51: grpc.AgentService.UpdateEphemeralMounts:input_type -> grpc.UpdateEphemeralMountsRequest
	9,  // 52: grpc.AgentService.StatsContainer:input_type -> grpc.StatsContainerRequest
	10, // 53: grpc.AgentService.PauseContainer:input_type -> grpc.PauseContainerRequest
	11, // 54: grpc.AgentService.ResumeContainer:input_type -> grpc.ResumeContainerRequest
	33, // 55: grpc.AgentService.RemoveStaleVirtiofsShareMounts:input_type -> grpc.RemoveStaleVirtiofsShareMountsRequest
	70, // 56: grpc.AgentService.GetDiagnosticData:input_type -> grpc.GetDiagnosticDataRequest
	24, // 57: grpc.AgentService.WriteStdin:input_type -> grpc.WriteStreamRequest
	26, // 58: grpc.AgentService.ReadStdout:input_type -> grpc.ReadStreamRequest
	26, // 59: grpc.AgentService.ReadStderr:input_type -> grpc.ReadStreamRequest
	28, // 60: grpc.AgentService.CloseStdin:input_type -> grpc.CloseStdinRequest
	29, // 61: grpc.AgentService.TtyWinResize:input_type -> grpc.TtyWinResizeRequest
	36, // 62: grpc.AgentService.UpdateInterface:input_type -> grpc.UpdateInterfaceRequest
	37, // 63: grpc.AgentService.UpdateRoutes:input_type -> grpc.UpdateRoutesRequest
	39, // 64: grpc.AgentService.ListInterfaces:input_type -> grpc.ListInterfacesRequest
	40, // 65: grpc.AgentService.ListRoutes:input_type -> grpc.ListRoutesRequest
	42, // 66: grpc.AgentService.AddARPNeighbors:input_type -> grpc.AddARPNeighborsRequest
	43, // 67: grpc.AgentService.GetIPTables:input_type -> grpc.GetIPTablesRequest
	45, // 68: grpc.AgentService.SetIPTables:input_type -> grpc.SetIPTablesRequest
	65, // 69: grpc.AgentService.GetMetrics:input_type -> grpc.GetMetricsRequest
	72, // 70: grpc.AgentService.MemAgentMemcgSet:input_type -> grpc.MemAgentMemcgConfig
	73, // 71: grpc.AgentService.MemAgentCompactSet:input_type -> grpc.MemAgentCompactConfig
	31, // 72: grpc.AgentService.CreateSandbox:input_type -> grpc.CreateSandboxRequest
	32, // 73: grpc.AgentService.DestroySandbox:input_type -> grpc.DestroySandboxRequest
	47, // 74: grpc.AgentService.OnlineCPUMem:input_type -> grpc.OnlineCPUMemRequest
	48, // 75: grpc.AgentService.ReseedRandomDev:input_type -> grpc.ReseedRandomDevRequest
	50, // 76: grpc.AgentService.GetGuestDetails:input_type -> grpc.GuestDetailsRequest
	52, // 77: grpc.AgentService.MemHotplugByProbe:input_type -> grpc.MemHotplugByProbeRequest
	53, // 78: grpc.AgentService.SetGuestDateTime:input_type -> grpc.SetGuestDateTimeRequest
	60, // 79: grpc.AgentService.CopyFile:input_type -> grpc.CopyFileRequest
	61, // 80: grpc.AgentService.GetOOMEvent:input_type -> grpc.GetOOMEventRequest
	63, // 81: grpc.AgentService.AddSwap:input_type -> grpc.AddSwapRequest
	64, // 82: grpc.AgentService.AddSwapPath:input_type -> grpc.AddSwapPathRequest
	67, // 83: grpc.AgentService.GetVolumeStats:input_type -> grpc.VolumeStatsRequest
	68, // 84: grpc.AgentService.ResizeVolume:input_type -> grpc.ResizeVolumeRequest
	69, // 85: grpc.AgentService.SetPolicy:input_type -> grpc.SetPolicyRequest
	83, // 86: grpc.AgentService.CreateContainer:output_type -> google.protobuf.Empty
	83, // 87: grpc.AgentService.StartContainer:output_type -> google.protobuf.Empty
	83, // 88: grpc.AgentService.RemoveContainer:output_type -> google.protobuf.Empty
	83, // 89: grpc.AgentService.ExecProcess:output_type -> google.protobuf.Empty
	83, // 90: grpc.AgentService.SignalProcess:output_type -> google.protobuf.Empty
	7,  // 91: grpc.AgentService.WaitProcess:output_type -> grpc.WaitProcessResponse
	83, // 92: grpc.AgentService.UpdateContainer:output_type -> google.protobuf.Empty
	83, // 93: grpc.AgentService.UpdateEphemeralMounts:output_type -> google.protobuf.Empty
	23, // 94: grpc.AgentService.StatsContainer:output_type -> grpc.StatsContainerResponse
	83, // 95: grpc.AgentService.PauseContainer:output_type -> google.protobuf.Empty
	83, // 96: grpc.AgentService.ResumeContainer:output_type -> google.protobuf.Empty
	83, // 97: grpc.AgentService.RemoveStaleVirtiofsShareMounts:output_type -> google.protobuf.Empty
	71, // 98: grpc.AgentService.GetDiagnosticData:output_type -> grpc.GetDiagnosticDataResponse
	25, // 99: grpc.AgentService.WriteStdin:output_type -> grpc.WriteStreamResponse
	27, // 100: grpc.AgentService.ReadStdout:output_type -> grpc.ReadStreamResponse
	27, // 101: grpc.AgentService.ReadStderr:output_type -> grpc.ReadStreamResponse
	83, // 102: grpc.AgentService.CloseStdin:output_type -> google.protobuf.Empty
	83, // 103: grpc.AgentService.TtyWinResize:output_type -> google.protobuf.Empty
	79, // 104: grpc.AgentService.UpdateInterface:output_type -> types.Interface
	35, // 105: grpc.AgentService.UpdateRoutes:output_type -> grpc.Routes
	34, // 106: grpc.AgentService.ListInterfaces:output_type -> grpc.Interfaces
	35, // 107: grpc.AgentService.ListRoutes:output_type -> grpc.Routes
	83, // 108: grpc.AgentService.AddARPNeighbors:output_type -> google.protobuf.Empty
	44, // 109: grpc.AgentService.GetIPTables:output_type -> grpc.GetIPTablesResponse
	46, // 110: grpc.AgentService.SetIPTables:output_type -> grpc.SetIPTablesResponse
	66, // 111: grpc.AgentService.GetMetrics:output_type -> grpc.Metrics
	83, // 112: grpc.AgentService.MemAgentMemcgSet:output_type -> google.protobuf.Empty
	83, // 113: grpc.AgentService.MemAgentCompactSet:output_type -> google.protobuf.Empty
	83, // 114: grpc.AgentService.CreateSandbox:output_type -> google.protobuf.Empty
	83, // 115: grpc.AgentService.DestroySandbox:output_type -> google.protobuf.Empty
	83, // 116: grpc.AgentService.OnlineCPUMem:output_type -> google.protobuf.Empty
	83, // 117: grpc.AgentService.ReseedRandomDev:output_type -> google.protobuf.Empty
	51, // 118: grpc.AgentService.GetGuestDetails:output_type -> grpc.GuestDetailsResponse
	83, // 119: grpc.AgentService.MemHotplugByProbe:output_type -> google.protobuf.Empty
	83, // 120: grpc.AgentService.SetGuestDateTime:output_type -> google.protobuf.Empty
	83, // 121: grpc.AgentService.CopyFile:output_type -> google.protobuf.Empty
	62, // 122: grpc.AgentService.GetOOMEvent:output_type -> grpc.OOMEvent
	83, // 123: grpc.AgentService.AddSwap:output_type -> google.protobuf.Empty
	83, // 124: grpc.AgentService.AddSwapPath:output_type -> google.protobuf.Empty
	84, // 125: grpc.AgentService.GetVolumeStats:output_type -> grpc.VolumeStatsResponse
	83, // 126: grpc.AgentService.ResizeVolume:output_type -> google.protobuf.Empty
	83, // 127: grpc.AgentService.SetPolicy:output_type -> google.protobuf.Empty
...
func file_agent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_agent_proto_msgTypes[55].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConfidentialStorage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
