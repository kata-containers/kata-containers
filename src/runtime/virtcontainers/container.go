	...
	for i := range c.mounts {
		...
		if di != nil {
			...
			if err != nil {
				...
				// TODO(burgerdev): consider permanent failure here, silent continuation may not be desirable
...
// 1. Block devices are supported by the hypervisor.
// 2. Block devices are allowed by config.
// 3. devicePath refers to a block device.
