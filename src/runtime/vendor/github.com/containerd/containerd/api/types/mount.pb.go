...
type Mount struct {
	...
	// just like configs that runtime need, take nydus as an example, kata-shim runtime needs
	// nydus image metadata file path and nydus daemon configurations
	ExtraOptions         []string `protobuf:"bytes,5,rep,name=extra_options,json=extraOptions,proto3" json:"extra_options,omitempty"`
...
var fileDescriptor_920196890d4a7b9f = []byte{
	...
	,
}
...
func (m *Mount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExtraOptions) > 0 {
		for iNdEx := len(m.ExtraOptions) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ExtraOptions[iNdEx])
			copy(dAtA[i:], m.ExtraOptions[iNdEx])
			i = encodeVarintMount(dAtA, i, uint64(len(m.ExtraOptions[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
...
func (this *Mount) String() string {
	...
	s := strings.Join([]string{`&Mount{`,
		...
		`ExtraOptions:` + fmt.Sprintf("%v", this.ExtraOptions) + `,`,
...
func (m *Mount) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.ExtraOptions = append(m.ExtraOptions, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
