...
// source: github.com/kata-containers/agent/protocols/grpc/agent.proto
...
func init() {
	proto.RegisterFile("github.com/kata-containers/agent/protocols/grpc/agent.proto", fileDescriptor_4a132446d64d28b7)
}
