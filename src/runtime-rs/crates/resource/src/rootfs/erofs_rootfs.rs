...
/// wrapper. For multiple devices, the returned structured layout is serialized
/// by the hypervisor after its backing files have been prepared.
///
...
async fn generate_merged_erofs_vmdk(
    ...
    // The path identifies this generated block source for device management and
    // logging. The QEMU transport serializes the structured layout directly.
...
///
/// Returns the generated-source identity, structured VMDK layout, GPT layout,
/// and generated metadata files.
