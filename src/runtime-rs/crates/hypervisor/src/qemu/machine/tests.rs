...
fn grace_4_gpu_and_nic() {
    check(
        HostTopology {
            sockets: single_socket(0..4),
            gpu_smmu_groups: smmu_groups(&[&["0008:06:00.0"]], 0),
            nic_smmu_groups: vec![GpuSmmuGroup {
                pci_bus_addrs: vec!["0008:00:00.0".into()],
                socket: 0,
            }],
            egm_sockets: vec![],
            numa_distances: vec![],
    ...
    let platform = Platform {
                ...
                PciRootComplex {
                    ...
                    root_ports: vec![
                        rp(
                            ...
                            0,
                            "0000:1b:00.0",
                            "vfio-5c7a307d86e7ae830",
                            "iommufdvfio-5c7a307d86e7ae830",
                            GpuPci,
                            0x2330,
                        ),
                        rp(
                            ...
                            1,
                            "0000:43:00.0",
                            "vfio-98077fd3aa014b541",
                            "iommufdvfio-98077fd3aa014b541",
                            GpuPci,
                            0x2330,
                        ),
                        rp(
                            ...
                            2,
                            "0000:52:00.0",
                            "vfio-35b65d16a30068022",
                            "iommufdvfio-35b65d16a30068022",
                            GpuPci,
                            0x2330,
                        ),
                        rp(
                            ...
                            3,
                            "0000:61:00.0",
                            "vfio-331446c1d73050393",
                            "iommufdvfio-331446c1d73050393",
                            GpuPci,
                            0x2330,
                        ),
                        rp(
                            ...
                            4,
                            "0000:07:00.0",
                            "vfio-b91919c2fa001cd18",
                            "iommufdvfio-b91919c2fa001cd18",
                            NvSwitch,
                            0x22a3,
                        ),
                        rp(
                            ...
                            5,
                            "0000:08:00.0",
                            "vfio-fab9e6a06185873e9",
                            "iommufdvfio-fab9e6a06185873e9",
                            NvSwitch,
                            0x22a3,
                        ),
                        rp(
                            ...
                            6,
                            "0000:09:00.0",
                            "vfio-3a77ef115d3f0ab610",
                            "iommufdvfio-3a77ef115d3f0ab610",
                            NvSwitch,
                            0x22a3,
                        ),
                        rp(
                            ...
                            7,
                            "0000:0a:00.0",
                            "vfio-2e0a336d490089a111",
                            "iommufdvfio-2e0a336d490089a111",
                            NvSwitch,
                            0x22a3,
                        ),
                    ],
                ...
                PciRootComplex {
                    ...
                    root_ports: vec![
                        rp(
                            ...
                            0,
                            "0000:9d:00.0",
                            "vfio-7f57f8dea75cdeca4",
                            "iommufdvfio-7f57f8dea75cdeca4",
                            GpuPci,
                            0x2330,
                        ),
                        rp(
                            ...
                            1,
                            "0000:c3:00.0",
                            "vfio-4461976d3de811155",
                            "iommufdvfio-4461976d3de811155",
                            GpuPci,
                            0x2330,
                        ),
                        rp(
                            ...
                            2,
                            "0000:d1:00.0",
                            "vfio-dc1944aed29728336",
                            "iommufdvfio-dc1944aed29728336",
                            GpuPci,
                            0x2330,
                        ),
                        rp(
                            ...
                            3,
                            "0000:df:00.0",
                            "vfio-5c974cdc2dcfe4cb7",
                            "iommufdvfio-5c974cdc2dcfe4cb7",
                            GpuPci,
                            0x2330,
                        ),
                    ],
        ...
        objects: Objects {
            ...
            numa_nodes: vec![
                ...
                NumaNode {
                    nodeid: 1,
                    memdev: Some("numa-mem1".to_owned()),
                    cpus: None,
                },
            ],
                ...
                PciRootComplex {
                    ...
                    root_ports: vec![
                        rp(
                            ...
                            0,
                            "0000:1b:00.0",
                            "vfio-4a182f997e753b150",
                            "iommufdvfio-4a182f997e753b150",
                            GpuPci,
                            0x2330,
                        ),
                        rp(
                            ...
                            1,
                            "0000:43:00.0",
                            "vfio-03bafd69f614ffb21",
                            "iommufdvfio-03bafd69f614ffb21",
                            GpuPci,
                            0x2330,
                        ),
                        rp(
                            ...
                            2,
                            "0000:52:00.0",
                            "vfio-947368d0843e55b42",
                            "iommufdvfio-947368d0843e55b42",
                            GpuPci,
                            0x2330,
                        ),
                        rp(
                            ...
                            3,
                            "0000:61:00.0",
                            "vfio-41adfe2466817df03",
                            "iommufdvfio-41adfe2466817df03",
                            GpuPci,
                            0x2330,
                        ),
                        rp(
                            ...
                            4,
                            "0000:07:00.0",
                            "vfio-7eff1447579be32f8",
                            "iommufdvfio-7eff1447579be32f8",
                            NvSwitch,
                            0x22a3,
                        ),
                        rp(
                            ...
                            5,
                            "0000:08:00.0",
                            "vfio-bfaa424dfcf1b24d9",
                            "iommufdvfio-bfaa424dfcf1b24d9",
                            NvSwitch,
                            0x22a3,
                        ),
                        rp(
                            ...
                            6,
                            "0000:09:00.0",
                            "vfio-585d94b2d0bd3b6b10",
                            "iommufdvfio-585d94b2d0bd3b6b10",
                            NvSwitch,
                            0x22a3,
                        ),
                        rp(
                            ...
                            7,
                            "0000:0a:00.0",
                            "vfio-44e4edb8e24e522911",
                            "iommufdvfio-44e4edb8e24e522911",
                            NvSwitch,
                            0x22a3,
                        ),
                    ],
                ...
                PciRootComplex {
                    ...
                    root_ports: vec![
                        rp(
                            ...
                            0,
                            "0000:9d:00.0",
                            "vfio-fd42e60b81a629b24",
                            "iommufdvfio-fd42e60b81a629b24",
                            GpuPci,
                            0x2330,
                        ),
                        rp(
                            ...
                            1,
                            "0000:c3:00.0",
                            "vfio-c3b4a6ef942a66a45",
                            "iommufdvfio-c3b4a6ef942a66a45",
                            GpuPci,
                            0x2330,
                        ),
                        rp(
                            ...
                            2,
                            "0000:d1:00.0",
                            "vfio-4ababdb3c8421bf06",
                            "iommufdvfio-4ababdb3c8421bf06",
                            GpuPci,
                            0x2330,
                        ),
                        rp(
                            ...
                            3,
                            "0000:df:00.0",
                            "vfio-2e0f5a646c1bbd557",
                            "iommufdvfio-2e0f5a646c1bbd557",
                            GpuPci,
                            0x2330,
                        ),
                    ],
...
fn grace_switch_port_emission() {
    ...
    assert!(
        joined.contains("x3130-upstream"),
        "upstream switch missing: {}",
        joined
    );
    assert!(
        joined.contains("xio3130-downstream"),
        "downstream port missing: {}",
        joined
    );
