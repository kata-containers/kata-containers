...
pub struct DeviceInfo {
    ...
    /// This value of pcie_switch_port device indicates that how many root ports to
    ...
    /// This value of pcie_bridge_port device indicates that how many bridge ports to
    /// be created when VM creation.
    /// It's valid when hotplug_vfio_on_root_bus is true and machine_type is "q35".
    #[serde(default)]
    pub pcie_bridge_port: u32,
