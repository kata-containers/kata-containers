...
/// Absolute path to the shell binary used by the agent debug console
...
mod tests {
    ...
    fn test_get_agent_kernel_params() {
        ...
        let agent_config = Agent {
            ...
            debug_console_shell: "/run/kata-extensions/devkit/bin/sh".to_string(),
        ...
        assert_eq!(
            ...
            "/run/kata-extensions/devkit/bin/sh"
        );
