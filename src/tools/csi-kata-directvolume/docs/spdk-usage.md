...
export RAW_DISKS=/var/lib/spdk/rawdisks
...
* StorageClass `spdk-test-adapted`
* PersistentVolumeClaim `kata-spdk-directvolume-pvc`
* Pod `spdk-pod-test`
...
* Usage is the same as regular PVCs — specify `volumetype=spdkvol` in the StorageClass.
