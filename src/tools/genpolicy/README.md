...
When user/group or supplementary group IDs matter for your workload (e.g. **nydus guest-pull**),
set them explicitly in the pod spec; see [How to use the Kata Agent Policy](../../../docs/how-to/how-to-use-the-kata-agent-policy.md) for details.
