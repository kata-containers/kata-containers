...
same level of support. This document aims to outline the maintenance levels of components in Kata Containers, so
...
| firecracker | Not maintained | [@kata-containers/firecracker](https://github.com/orgs/kata-containers/teams/firecracker) | Some development. No CI testing |
| remote | Not maintained | | Remote hypervisor with an active implementation in [cloud-api-adaptor](https://github.com/confidential-containers/cloud-api-adaptor). No Kata CI, no support for runtime-rs |
| | | | |
| **Tools** | | | |
...
| CoCo Stability | Deprecated | | Not maintained and disabled for 7 months |
...
| run-tracing | Deprecated and remove before 4.0? | | Not maintained. CI disabled for over 18 months |
| run-vfio | Deprecated and remove before 4.0? | | Not maintained. CI disabled for over 18 months |
...
| docs url alive check | Deprecated and remove before 4.0? | | Not maintained. Never passed on github |
| metrics tests | Deprecated and remove before 4.0? | | Not maintained. Test runner not available |
| kata-monitor tests | Deprecated? | | Not maintained. Only running against crio with qemu |
| docker tests | Not maintained | | Not maintained. |
...
| k0s | Best effort | | Some CI testing and support in kata-deploy |
| rke2 | Best effort | | Some CI testing and support in kata-deploy |
| microk8s | Best effort | | Some CI testing and support in kata-deploy |
| k3s | Not maintained | | Some CI testing, some workarounds needed in kata-deploy |
...
| Tracing | Deprecated | | OpenTelemetry/Jaeger integration. Disabled by default. trace-forwarder has CVEs. Not recommended for production |

*Note: GitHub teams marked with * may need to be created or updated

### Table TODO
- Create/update GitHub teams for new categories
- Review and update deprecated items for potential removal
