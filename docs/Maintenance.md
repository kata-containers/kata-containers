...
help users understand the classification of each component.
...
| AMD SEV-SNP | Supported | [@kata-containers/amd-snp](https://github.com/orgs/kata-containers/teams/amd-snp) | The project has CI and active development. |
...
| vsock-exporter | Deprecated | | No maintainers, no testing. Long term CVEs |
| | | | |
...
| cbl-mariner | Supported | [@kata-containers/cbl-mariner](https://github.com/orgs/kata-containers/teams/cbl-mariner) | Tested in the CI on x86 |
